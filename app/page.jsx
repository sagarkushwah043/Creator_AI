...
const Home = () => {
  ...
  <Button
    key={index}
    variant={activeTab === index ? "pop" : "purpleHover"} // active vs inactive
    onClick={() => setActiveTab(index)}
    className="w-full justify-start h-auto p-4 sm:p-6 flex items-center gap-4"
  >
    {/* Icon container */}
    <div
    ...
    <div className="text-left">
      <h3 className="font-bold text-lg text-white">{tab.title}</h3>
    </div>
  </Button>
))}
...
<section className="relative z-10 py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-r from-gray-900/50 to-purple-900/20">
  <div className="max-w-4xl mx-auto text-center">
    ...
    <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed">
    ...
    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
      ...
      >
        <Link href="/dashboard" className="flex items-center justify-center gap-2 w-full sm:w-auto">
          Start Your Journey
      ...
      <Button
        ...
        className="rounded-full w-full sm:w-auto"
      >
        <Link href="/feed" className="flex items-center justify-center w-full sm:w-auto">
          Explore the Feed
        </Link>
      </Button>
    </div>
     ...
     {/* Footer */}
          <footer className="relative z-10 border-t border-gray-800 py-8 px-4 sm:px-6 bg-black">
            <div className="max-w-7xl mx-auto text-center">
