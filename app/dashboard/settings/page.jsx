...
export default function SettingsPage() {
  ...
  // Mock user for UI
  const currentUser = { username: "mockuser" };
  ...
  // Update form when user data loads (fixed infinite loop)
  useEffect(() => {
    if (currentUser && currentUser.username !== getValues("username")) {
      reset({ username: currentUser.username || "" });
    }
  }, [currentUser, reset, getValues]);
